...
\begin{acknowledgements}
  ...
  Many thanks to my family, especially my parents and siblings to whom this work is dedicated (see dedication), for the understanding during the many months I was away. There are also friends and colleagues at Wits University and beyond who provided critical support. Gratitude to Muchiri Githiria, Eddy Ombagi and other residents of \texttt{76\ Long\ Street}. I will never forget that wonderful trip to \texttt{Maputo,\ Mozambique}, and the great moments in Bloemfontein, Brits, Gaborone, Durban, and Mahikeng, plus the nights at the blind PIG and Melville.

  I also thank the people working for the \href{https://www.r-project.org/foundation/}{\texttt{R} Foundation} for availing of such a beautiful data analysis software without subscription fees. Profuse thanks to ALL the people at \href{http://rstudio.com}{RStudio} and Hadley Wickham, the originator of the Tidyverse, for making data analysis palatable, accessible, and even, at times, fun. These gratitudes should extend to the entire open source community - I have even switched to \href{https://www.linuxfoundation.org/}{\texttt{Linux}}. Finally, I thank \href{https://www.edx.org/}{\texttt{EdX}} for funding a large portion of the \texttt{Professional\ Certificate\ in\ Data\ Science} training that changed my approach and attitude towards data analysis.
...
\caption{\label{tab:unnamed-chunk-114}Summary Statistics: Inputs and Outputs for the DEA Model}
\centering
\fontsize{10}{12}\selectfont
\begin{tabular}[t]{lrrrrrrr}
\toprule
...
\caption{\label{tab:unnamed-chunk-115}Description of Independent Variables}
\centering
\fontsize{9}{11}\selectfont
\begin{tabu} to \linewidth {>{\raggedright}X}
\toprule
...
\caption{\label{fig:unnamed-chunk-116}Correlation Matrix for DEA Inputs and Outputs}
\end{figure}
...
\caption{\label{tab:unnamed-chunk-117}Summary Statistics for Efficiency Scores}
\centering
\fontsize{9}{11}\selectfont
\begin{tabular}[t]{lrrrrrrr}
\toprule
...
\caption{\label{fig:unnamed-chunk-118}Financial Efficiency Scores for MFIs in Africa}
\end{figure}
...
Overall, the social efficiency of MFIs in Africa is high, with a mean and median of 0.79 and 0.78, respectively. However, as Figure 5.3 and 5 show, NGOs have consistently the highest levels of social efficiency, followed by NBFIs and other forms of MFIs. Rural banks and credit unions, respectively, are the least socially efficient. Considering the financial efficiency scores, it appears that commercialization causes mission drift. Also, both NGOs and NBFIs show a noTable 5.decline in social performance over time, which could also be an indictment of the shift towards financial sustainability \autocite{d2017ngos}.
...
\caption{\label{fig:unnamed-chunk-119}Social Efficiency Scores for MFIs in Africa}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-120}Financial and Social Efficiency Scores for MFIs in Africa}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-121}Trends in Financial and Social Efficiency Scores}
\end{figure}
...
\caption{\label{tab:unnamed-chunk-122}Summary Statistics: Independent Variables for Regression Model}
\centering
\fontsize{9}{11}\selectfont
\begin{tabular}[t]{lrrrrrrr}
\toprule
...
\caption{\label{tab:unnamed-chunk-133}Results of the Hausmann Tests}
\centering
\fontsize{9}{11}\selectfont
...
\caption{\label{fig:unnamed-chunk-134}Financial Sustainability and Social Performance Metrics for MFIs in Africa}
\end{figure}
...
{\centering \includegraphics{_main_files/figure-latex/unnamed-chunk-138-1} 

}

\caption{residual QQ-plots for Fixed and Random Effects Regression Models}\label{fig:unnamed-chunk-138}
\end{figure}
...
\caption{\label{tab:unnamed-chunk-153}Summary Statistics for Categrical Independent Variables}
\centering
\fontsize{8}{10}\selectfont
...
\caption{\label{tab:unnamed-chunk-154}Description of Variables}\\
\toprule
Variable\_Description\\
\midrule
\endfirsthead
\caption[]{\label{tab:unnamed-chunk-154}Description of Variables \textit{(continued)}}\\
\toprule
Variable\_Description\\
\midrule
\endhead
...
\caption{\label{tab:unnamed-chunk-155}Summary Statistics}
\centering
\fontsize{10}{12}\selectfont
...
\caption{Correlation Matrix for Independent Variables}\label{fig:unnamed-chunk-156}
\end{figure}
...
\caption{Capital Sources by MFI Legal Status}\label{fig:unnamed-chunk-157}
\end{figure}
...
\caption{Assets, Asset Structure, and Profit margin of MFIs in Africa}\label{fig:unnamed-chunk-158}
\end{figure}
...
\caption{Trends in Capital, Debt, Deposits, and Donations}\label{fig:unnamed-chunk-159}
\end{figure}
...
\caption{\label{tab:unnamed-chunk-160}Summary Statistics for Categrical Independent Variables}
\centering
\fontsize{9}{11}\selectfont
\begin{tabu} to \linewidth {>{\raggedright}X>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X}
\toprule
...
\caption{\label{tab:unnamed-chunk-164}Mean and Median Donations and Donations to Assets Ratio}
\centering
\fontsize{9}{11}\selectfont
\begin{tabu} to \linewidth {>{\raggedright}X>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X}
\toprule
...
\caption{\label{tab:unnamed-chunk-166}Hausmann Tests}
\centering
\fontsize{9}{11}\selectfont
...
\caption{\label{tab:unnamed-chunk-167}Variance Inflation Factors}
\centering
\fontsize{9}{11}\selectfont
